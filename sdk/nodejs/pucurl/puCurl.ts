 ...
 */
export class PuCurl extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PuCurl {
        return new PuCurl(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pucurl:pucurl:PuCurl';

    /**
     * Returns true if the given object is an instance of PuCurl.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PuCurl {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PuCurl.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: PuCurlArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PuCurl.__pulumiType, name, resourceInputs, opts);
    }
}
