...
namespace Pulumi.Pucurl
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Pucurl.version.txt");
    ...
    internal sealed class PucurlResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public PucurlResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
