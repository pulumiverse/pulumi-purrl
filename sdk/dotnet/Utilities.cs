...
namespace Pulumiverse.Purrl
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumiverse.Purrl.version.txt");
    ...
    internal sealed class PurrlResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public PurrlResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
